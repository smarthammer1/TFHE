...
void comp_covar(double *plain_a, double *plain_b, LweSample** a, LweSample** b, const int length, int32_t N, float bs_time, const TFheGateBootstrappingCloudKeySet* bk, TFheGateBootstrappingSecretKeySet* key);

void comp_ft (double *plain_a, double *plain_b, LweSample** a, LweSample** b, int sec_param, int32_t length, const TFheGateBootstrappingCloudKeySet* bk, TFheGateBootstrappingSecretKeySet* key);
void comp_RealMult(double *plain_a, double *plain_b, LweSample** a, LweSample** b, const int length, int32_t N, float bs_time, const TFheGateBootstrappingCloudKeySet* bk, TFheGateBootstrappingSecretKeySet* key);
